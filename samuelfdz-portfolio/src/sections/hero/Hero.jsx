                ...
                <main className="hero__content">
                    ...
                    <section className="hero__work">
                        ...
                        <div className="hero__work__socials">
                            <a href="https://www.linkedin.com/in/samuel-fernandezz/" className="hero__work__socials__link" target="_blank">
                            ...
                            <a href="https://github.com/SamuelFDEZS" className="hero__work__socials__link" target="_blank">
